...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div class="stat-card bg-gradient-to-br from-gray-700 to-gray-900 rounded-xl shadow-lg p-4 sm:p-6 text-white">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div>
                    <p class="text-gray-300 text-xs sm:text-sm font-medium">Produktet</p>
            ...
            <div class="flex items-center text-xs sm:text-sm text-gray-300"><i class="fas fa-arrow-up mr-1"></i><span>Total në inventar</span></div>
        </div>
        ...
        <div class="stat-card bg-gradient-to-br from-slate-600 to-slate-800 rounded-xl shadow-lg p-4 sm:p-6 text-white">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div>
                    <p class="text-slate-200 text-xs sm:text-sm font-medium">Klientët</p>
            ...
            <div class="flex items-center text-xs sm:text-sm text-slate-200"><i class="fas fa-user-plus mr-1"></i><span>Total të regjistruar</span></div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-bold text-gray-800"><i class="fas fa-shopping-bag mr-2 text-gray-900"></i>Porositë e Fundit</h2>
                    <a href="{{ route('dashboard.orders.index') }}" class="text-sm text-gray-900 hover:text-black font-medium">Shiko të gjitha <i class="fas fa-arrow-right ml-1"></i></a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-bold text-gray-800"><i class="fas fa-box-open mr-2 text-slate-700"></i>Produktet e Fundit</h2>
                <a href="{{ route('dashboard.products.index') }}" class="text-sm text-gray-900 hover:text-black font-medium">Shiko të gjitha <i class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 hover:shadow-md transition-shadow">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('dashboard.products.edit', $product->id) }}" class="text-gray-900 hover:text-black"><i class="fas fa-edit"></i></a>
                ...
                @empty
                    <div class="col-span-3 text-center py-12 text-gray-500">
                        ...
                        <a href="{{ route('dashboard.products.create') }}" class="inline-block mt-4 bg-gray-900 text-white px-6 py-2 rounded-lg hover:bg-black">Shto Produkt</a>
                    </div>
                @endforelse
            </div>
        </div>
