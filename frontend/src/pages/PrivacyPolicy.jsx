      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow p-8 max-w-3xl mx-auto">
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <li>Informacione teknike: adresa IP, informacion për shfletuesin dhe pajisjen (për qëllime sigurie dhe diagnostikimi).</li>
          </ul>
          ...
          <p className="text-gray-700 font-medium">
            Email:{" "}
            <a href="mailto:info@minimodaks.com" className="underline hover:text-gray-900">
              info@minimodaks.com
            </a>
          </p>
