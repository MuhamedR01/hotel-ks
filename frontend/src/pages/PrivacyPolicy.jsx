          ...
          <h2 className="text-lg font-semibold mt-4 mb-2">
            1. Të dhënat që mbledhim
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  telefon, adresë), përse i mbledhim, si i përdorim, me kë i ndajmë dhe
                  të drejtat që keni mbi këto të dhëna.
                </p>

                <h2 className="text-lg font-semibold mt-6 mb-2">2. Të dhënat që mbledhim</h2>
                <ul className="list-disc list-inside text-gray-700 mb-4">
                  <li>Informacion personal: emër, mbiemër, numër telefoni, adresë.</li>
                  <li>Detajet e porosisë: produktet, sasia, çmimi, madhësitë e zgjedhura.</li>
                  <li>Informacione teknike: adresa IP, informacion për shfletuesin dhe
                    pajisjen (për qëllime sigurie dhe diagnostikimi).</li>
                </ul>

                <h2 className="text-lg font-semibold mt-6 mb-2">3. Përse i përdorim të dhënat</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">4. Legaliteti i përpunimit</h2>
                <p className="text-gray-700 mb-4">
                  Përpunimi i të dhënave bazohet në nevojën për të përmbushur kontratën
                  (përpunimi i porosisë), në interesin legjitim të sigurisë dhe
                  funksionimit të shërbimit, dhe kur është e nevojshme, në pëlqimin
                  tuaj për komunikime marketingu.
                </p>

                <h2 className="text-lg font-semibold mt-6 mb-2">5. Si i ruajmë dhe i mbrojmë të dhënat</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">6. Afati i ruajtjes</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">7. Palët e treta dhe transferimet</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">8. Cookies dhe teknologji të ngjashme</h2>
                <p className="text-gray-700 mb-4">
                  ...
                  Nëse kërkoni, mund të ofrojmë më shumë detaje për cookie-t aktive dhe
                  mënyrën e menaxhimit të tyre.
                </p>

                <h2 className="text-lg font-semibold mt-6 mb-2">9. Të drejtat tuaja</h2>
                <p className="text-gray-700 mb-4">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  Ndryshimet e rëndësishme do të njoftohen në këtë faqe dhe, kur
                  jetë e nevojshme, do t'ju njoftojmë drejtpërdrejt.
                </p>

                <p className="text-sm text-gray-500 mt-6">Dokument i fundit i përditësuar: Dhjetor 2025</p>
          </p>

          <h2 className="text-lg font-semibold mt-4 mb-2">4. Kontakt</h2>
