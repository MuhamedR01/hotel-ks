...
function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost/hotel-ks/backend/create_order.php', {
        method: 'POST',
        headers: {
  ...
  if (cart.length === 0 && !isSubmitting.current) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600">Shporta është bosh. Duke ju ridrejtuar...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Përfundimi i Porosisë</h1>
            <p className="text-gray-600 mt-2">Plotësoni të dhënat tuaja për të përfunduar porosinë</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Informacioni i Dërgimit</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="north macedonia">Maqedoni e Veriut</option>
                      </select>
                      {errors.country && (
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-8">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Përmbajtja e Porosisë</h2>
                ...
                <div className="border-t border-gray-200 pt-4 space-y-2">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Taksë (8%):</span>
